 ...
 * 
 * Self-contained pipeline infrastructure for the payout-domain domain:
...
export interface PayoutDomainPipelineStackProps extends cdk.StackProps {
  domain: string;
...
export class PayoutDomainPipelineStack extends cdk.Stack {
  public readonly artifactBucket: s3.Bucket;

  constructor(scope: Construct, id: string, props: PayoutDomainPipelineStackProps) {
