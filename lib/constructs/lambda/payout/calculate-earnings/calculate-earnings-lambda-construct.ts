...
export class CalculateEarningsLambdaConstruct extends Construct {
  ...
  constructor(scope: Construct, id: string, props: CalculateEarningsLambdaConstructProps) {
    ...
    const lambdaCodePath = path.join(__dirname, '../../../../functions/lambda/payout/calculate-earnings/calculate-earnings-lambda.ts');
    this.function = new NodejsFunction(this, 'CalculateEarningsFunction', {
