...
export class ListEarningsLambdaConstruct extends Construct {
  ...
  constructor(scope: Construct, id: string, props: ListEarningsLambdaConstructProps) {
    ...
    const lambdaCodePath = path.join(__dirname, '../../../../functions/lambda/payout/list-earnings/list-earnings-lambda.ts');
    this.function = new NodejsFunction(this, 'ListEarningsFunction', {
