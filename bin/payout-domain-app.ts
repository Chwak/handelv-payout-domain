...
import { PayoutDomainPipelineStack } from "../lib/payout-domain-pipeline-stack";
...
new PayoutDomainPipelineStack(
  app,
  "PayoutDomainPipelineStack",
  {
    ...
    prodAccountId,
    githubConnectionArn,
    description: "Domain-scoped pipeline for payout-domain",
  }
);
